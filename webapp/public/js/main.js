    ...
    $.ajax({
        ...
        success: function (data, textStatus, jqXHR) {
            ...
            if (img.length != 1) {
              ...
              if (img.includes('23px') || img.includes('Ambox_important') || img.includes('Ambox_current') || img.includes('Wiki_letter_w.svg') || img.includes('Question_book-new.svg') || img.includes('Edit-clear')) {
                img = undefined;
